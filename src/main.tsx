...
import VideoIntroducaoPage from './pages/main/video-introdutorio/index.tsx';
import SettingsPage from './pages/main/configuracoes/index.tsx';
  ...
  <StrictMode>
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/main/video-introdutorio" element={<VideoIntroducaoPage />} />
        <Route path="/main/configuracoes" element={<SettingsPage />} />
